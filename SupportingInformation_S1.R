#### CODE USED TO PRODUCE SUPPORTING INFORMATION S1 ####
...
# subset of individual with at least four breeding attempts
...
#### ____ Var early-life probability of successful reproduction  #### 
...
#### ____ Var probability of successful reproduction at the onset of senescence  #### 
...
#### Figure S1.2: Relationship between individual predicted age at the onset of senescence and senescence rate  #### 
...
Fig_S1_3_A = ggplot(data = SubsetDead_cohortBefore2000_noOutlier[which(SubsetDead_cohortBefore2000_noOutlier$population=="Bird island"),], 
...
Fig_S1_3_B = ggplot(data = SubsetDead_cohortBefore2000_noOutlier[which(SubsetDead_cohortBefore2000_noOutlier$population=="Kerguelen"  ),], 
                 aes(x =SenesceRate_from_backTransformedCoefs , y=OnsetSenesc_from_backTransformedCoefs , col = LRS))+
  geom_point(size = 1.5, alpha = 0.6)+
...
cowplot::plot_grid(Fig_S1_3_A, Fig_S1_3_B)
...
preds_onset <- fitted(
  GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence,
  newdata = newdata_onset,
  summary = TRUE
)

newdata_onset$OnsetSenescence_plot <-    newdata_onset$OnsetSenescence_std *
...
Fig_S1_3_C <- ggplot() +
  geom_ribbon(
    data = newdata_onset,
    aes(x = OnsetSenescence_plot, ymin = Q2.5, ymax = Q97.5, fill = population),
    alpha = 0.3
  ) +
  geom_line(
    data = newdata_onset,
    aes(x = OnsetSenescence_plot, y = Estimate, color = population),
    linewidth = 1
  ) +
  geom_jitter(
    data = SubsetDead_cohortBefore2000_noOutlier,
    aes(x = OnsetSenesc_from_backTransformedCoefs, y = LRS, color = population),
    width = 0,
    height = 0.2,
    alpha = 0.5,
    size = 1.5
...
preds_rate <- fitted(
  GLM_KerBI_Poisson_BRM_LRS_SenesceRate,
  newdata = newdata_rate,
  summary = TRUE
)


newdata_rate$SenesceRate_plot <-    newdata_rate$SenesceRate_std *
...
# GLMM testing the relationship between LRS and onset and rate of senescence for each population and for dead and alive individuals 
...
GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive  = brm(LRS   ~   OnsetSenescence_std * population * DeadOrNot ,
...
summary(GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive) 
bayes_R2(GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive) 
...
GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive_refKer  = brm(LRS   ~    OnsetSenescence_std * population_refKer * DeadOrNot ,
                                                        data=df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier ,
                                                        family = poisson   ,
                                                        warmup = 2000,
                                                        iter = 4000,
...
summary(GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive_refKer) 
...
GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive_refDead  = brm(LRS   ~   OnsetSenescence_std * population * DeadOrNot_refDead ,
                                                 data=df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier ,
                                                 family = poisson   ,
                                                 warmup = 2000,
                                                 iter = 4000,
...
summary(GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive_refDead) 



GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive_refKer_refDead  = brm(LRS   ~    OnsetSenescence_std * population_refKer * DeadOrNot_refDead ,
                                                        data=df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier ,
                                                        family = poisson   ,
                                                        warmup = 2000,
                                                        iter = 4000,
...
summary(GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive_refKer_refDead) 


# Senescence rate 
GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive  = brm(LRS   ~   SenesceRate_std * population * DeadOrNot ,
                                             data=df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier ,
                                             family = poisson   ,
                                             warmup = 2000,
                                             iter = 4000,
...
summary(GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive) 
bayes_R2(GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive) 


df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$population=as.factor(df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$population)
df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$population_refKer = relevel(df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$population , ref=2)

GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive_refKer  = brm(LRS   ~    SenesceRate_std * population_refKer * DeadOrNot ,
                                                    data=df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier ,
                                                    family = poisson   ,
                                                    warmup = 2000,
                                                    iter = 4000,
...
summary(GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive_refKer) 

df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$DeadOrNot=as.factor(df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$DeadOrNot)
df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$DeadOrNot_refDead = relevel(df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier$DeadOrNot , ref=2)


GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive_refDead  = brm(LRS   ~   SenesceRate_std * population * DeadOrNot_refDead ,
                                                     data=df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier ,
                                                     family = poisson   ,
                                                     warmup = 2000,
                                                     iter = 4000,
...
summary(GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive_refDead) 



GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive_refKer_refDead  = brm(LRS   ~    SenesceRate_std * population_refKer * DeadOrNot_refDead ,
                                                            data=df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier ,
                                                            family = poisson   ,
                                                            warmup = 2000,
                                                            iter = 4000,
...
summary(GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive_refKer_refDead) 

# pp_check(GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive_refKer_refDead)



ranges_onset <- df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier %>%
...
preds_onset <- fitted(  GLM_KerBI_Poisson_BRM_LRS_OnsetSenescence_DeadOrAlive,
...
Fig_S1_4_C <- ggplot() +
  ...
  geom_ribbon(    data = newdata_onset,    aes(      x = OnsetSenesc_plot,      ymin = Q2.5,      ymax = Q97.5,      fill = pop_DeadOrNot
  ),    alpha = 0.25  ) +
  geom_line(    data = newdata_onset,    aes(      x = OnsetSenesc_plot,      y = Estimate,      color = pop_DeadOrNot
  ),    linewidth = 1  ) +
...
ranges_rate <- df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier %>%
  group_by(population, DeadOrNot, pop_DeadOrNot) %>%
...
preds_rate <- fitted(  GLM_KerBI_Poisson_BRM_LRS_SenesceRate_DeadOrAlive,
                          newdata = newdata_rate,
                          summary = TRUE
)
...
Fig_S1_4_D <- ggplot() +
    geom_jitter(    data = df_AgeStd_randomSlopesAndInterceptsIDlevel_noOutlier,
                  aes(      x = SenesceRate_from_backTransformedCoefs,      y = LRS,      color = pop_DeadOrNot    ),
                  width = 0,    height = 0.2,    alpha = 0.4,    size = 1.5
  ) +
  geom_ribbon(    data = newdata_rate,
                  aes(      x = SenesceRate_plot,      ymin = Q2.5,      ymax = Q97.5,      fill = pop_DeadOrNot
                  ),    alpha = 0.25  ) +
  geom_line(    data = newdata_rate,
